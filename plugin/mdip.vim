...
function! g:MarkdownPasteImageTitleMode(relpath)
	...
	execute "normal! i\t<img style=\"border-radius: 0.3125em;box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);\" width=\"80%\"\<CR>"
...
function! mdip#MarkdownClipboardImage()
    ...
    if tmpfile == 1
        ...
        if exists('g:mdip_upload')
            let cmd = g:mdip_upload . " " . relpath
            let relpath = system(cmd)
        endif
